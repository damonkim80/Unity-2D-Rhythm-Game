...
using System.IO; //Alt + E 사용 시 using 자동 추가 가능
using UnityEngine;
...
public class NoteController : MonoBehaviour
{
    ...
    void Start()
    {
        noteObjectPooler = gameObject.GetComponent<ObjectPooler>(); //변수 초기화
        // 리소스에서 비트(Beat) 텍스트 파일을 불러옵니다. -> notes.Add(new Note(1, 1));
        ...
        // 1초마다 떨어지는 비트 개수(BPS = BPM / 60)
        beatCount = (float)bpm / divider; // 빠르게 60대신 30으로 해줌
        // 비트가 떨어지는 간격 시간
